                                                ...
                                                <div class="os-progress-bar blue">
                                                    <div class="bar-labels">
                                                        <div class="bar-label-left">
                                                            <span>Осталось</span><span class="positive">4 Гб</span>
                                                        </div>
                                ...
                                <div class="project-box">
                                    <div class="project-head">
                                        ...
                                        <div class="project-users">
                                            <a class="btn btn-white btn-rounded" href="/admin/technologies" target="_blank">перейти</a>
                                        </div>
                                    </div>
                                    <div class="project-info">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-5 offset-sm-2">
                                                <div class="os-progress-bar blue">
                                                    <div class="bar-labels">
                                                        <div class="bar-label-left">
                                                            <span>Progress</span><span class="positive">+10</span>
                                                        </div>
                                                        <div class="bar-label-right">
